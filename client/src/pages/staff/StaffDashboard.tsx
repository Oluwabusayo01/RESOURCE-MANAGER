...
import { bookingService, notificationService, libraryService } from '@/lib/apiService'
import type { Booking, Notification, LibraryMaterial } from '@/types'
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-dark-gray text-[10px] sm:text-sm mt-1">Here's what's happening with your bookings and materials.</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          ...
          <div className="text-left">
            <p className="font-bold text-lg text-accent">Upload Study Material</p>
            <p className="text-sm text-dark-gray">Share notes & slides</p>
          </div>
        </button>
      </div>
